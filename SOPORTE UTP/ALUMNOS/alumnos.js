...
function modalAlumno(e) {
    ...
    function textoPorCadaAlumnoMujer() {
        return `Bienvenida alumna <span>${nombre}</span>. Por favor, utilice los siguientes botones para conocer las notas de todos sus cursos, así como también su ponderado final.`;
    }

    function textoPorCadaAlumnoHombre() {
        return `Bienvenida alumno <span>${nombre}</span>. Por favor, utilice los siguientes botones para conocer las notas de todos sus cursos, así como también su ponderado final.`;
    }
